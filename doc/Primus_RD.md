...
##DATABASENS INNHOLD:
Databasen inneholder tabeller som i `Primus_Schema.md`. Resultattabellen er `nmmfoto`.
...
* Jeg har tilgjengelig VB Studio Code, Notebook++, Access, phpMySQL ver 5.2.2, MySQL Workbench ver 8.0 CE og xmapp.
